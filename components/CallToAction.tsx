          ...
          <div className="relative p-10 md:p-14 rounded-3xl bg-gradient-to-br from-violet-600/15 via-purple-600/10 to-fuchsia-600/15 border border-white/10 overflow-hidden">
            ...
            <div className="relative z-10 text-center">
              ...
              <p className="text-lg text-neutral-400 mb-10 max-w-xl mx-auto">
                Let&apos;s turn your vision into a product users love. From MVP to scale — I&apos;ve got you covered.
              </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8">
            {contactCards.map((card, index) => (
              ...
              >
                ...
                <h3 className="text-sm font-medium text-neutral-200 mb-1">{card.title}</h3>
                <p className="text-xs text-neutral-500 truncate">{card.value}</p>
              </a>
            ))}
          </div>
        </div>
