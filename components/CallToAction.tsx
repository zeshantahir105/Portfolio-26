    ...
    <section id="contact" className="py-24 relative bg-white">
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto">
          {/* Main CTA Box */}
          <div className="relative p-10 md:p-14 rounded-3xl bg-gradient-to-br from-violet-600/10 via-purple-600/5 to-fuchsia-600/10 border border-violet-100 overflow-hidden">
            <div className="relative z-10 text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-10">
                ...
                <a
                  href="#projects"
                  className="flex items-center gap-2 px-8 py-4 bg-white border border-neutral-200 hover:border-violet-300 text-neutral-700 hover:text-neutral-900 rounded-xl font-semibold transition-all duration-300 w-full sm:w-auto justify-center"
                >
              ...
              {/* Quick Links */}
              <div className="flex flex-wrap justify-center gap-6 pt-8 border-t border-violet-100">
                <a
                  href="https://www.linkedin.com/in/muhammad-zeshan-tahir-638423179/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 text-neutral-600 hover:text-violet-500 transition-colors"
                >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8">
            {contactCards.map((card, index) => (
              <a
                ...
                className="group p-5 rounded-xl bg-white border border-neutral-200 hover:border-violet-300 transition-colors duration-200 text-center"
              >
